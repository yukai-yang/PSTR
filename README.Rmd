...
print(pstr, "tests")
```
The function "LinTest" takes the PSTR object "pstr" and overwrites it due to that the class PSTR is using reference semantics.
...
pstr0 = pstr$clone()
```
By doing so, the new PSTR object pstr0 refers to another model, and when you do something on either of the two objects (pstr or pstr0), the other one remains unchanged.
